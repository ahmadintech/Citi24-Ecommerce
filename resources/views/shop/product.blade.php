                            ...
                            <a href="{{ route('shop.product.details', ['product_name' => $row->product_name]) }}">
                                <img class="product-image"
                                    src="{{ $row->images->first()
                                        ? asset('storage/product_images/small/' . $row->images->first()->image)
                                        : asset('storage/product_images/small/default.jpg') }}"
                                    alt="{{ $row->product_name }}" loading="lazy">
                            </a>
                    ...
                    <div class="category-card">
                        <a href="{{ route('shop.category', ['name' => $category->name]) }}" class="category-link">
                            <div class="category-icon">
                                <i class="fas fa-globe-africa"></i> <!-- Default icon, you can customize per category -->
                            </div>
